...
<body>
    <center>
        <form action="<?= base_url('tokosepatu1/cetak'); ?>" method="post">
            <table bgcolor='turquoise' width="250px">
                <tr>
                    <th>
                ...
                <tr>
                    <td colspan="3"><input type="text" name="nama" id="nama" placeholder="Nama"></td>
                </tr>
                <tr>
